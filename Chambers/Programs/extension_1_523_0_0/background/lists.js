...
function startAnonySettingsInterval(rand, callback) {
    ...
    jobRunner.run('anony-settings', function() {
        callUrl( { url: stndz.resources.transition, headers: [{ name: 'Content-Type', value: 'text/plain' }] }, function(conf) {
