...
function handleWindowMessages(event) {
    if (pageData && event.data && event.data.type == stndz.messages.contentScriptVersionUpgrade && event.data.machineId == pageData.machineId && event.data.iframeGuid != iframeGuid) {
